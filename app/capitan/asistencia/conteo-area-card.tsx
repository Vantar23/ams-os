    ...
    <form onSubmit={onSubmit} className="mt-4 grid grid-cols-1 gap-4">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <input
          ...
          className="min-w-0 flex-1 rounded-lg border border-border bg-background py-3 text-center text-5xl font-semibold tabular-nums tracking-tight outline-none focus-visible:ring-2 focus-visible:ring-ring [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
